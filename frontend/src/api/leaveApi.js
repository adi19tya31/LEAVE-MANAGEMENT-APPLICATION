...
export const getTeamApplications = (token) =>
  apiFetch("/api/leave-applications/team-history", { token });


export const getCalendarLeaves = (token) =>
  apiFetch("/api/leave-applications/calendar", {
    method: "GET",
    token,
  });